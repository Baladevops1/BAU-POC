...
@Component({
  selector: 'app-idctransfer',
  templateUrl: './idctransfer.component.html',
  styleUrls: ['./idctransfer.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class IdctransferComponent implements OnInit {
  constructor(
  ...
  steps: any = [
    { p: 'planning', h2: 'request', active: true },
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params: any) => {
      this.status = params['status'] || 'request';

      if (this.status === 'approval') {
        this.steps[0].active = false;
        this.steps[1].active = true;

        this.selectedFrom = this.interdataService.interdataList[0].fromLocation;
        this.selectedTo = this.interdataService.interdataList[0].toLocation;
        this.division = this.interdataService.interdataList[0].toDivision;

        var timestamp = Date.parse(
          this.interdataService.interdataList[0].shipmentDeliveryDate
        );
        console.log(this.interdataService.interdataList[0], timestamp);

        let d: any =
          this.interdataService.interdataList[0].shipmentDeliveryDate.split(
            '/'
          );
        ...
        this.items = JSON.parse(
          JSON.stringify(this.interdataService.interdataList[0].gridData)
        );

        let data = this.interdataService.interdataList[0].orders.forEach(
          (v: any, j: any) => {
            if (v.id === this.interdataService.interdataList[0].id) {
              this.orderIndex = j;
            }
            return v.id === this.interdataService.interdataList[0].id;
          }
        );
      } else {
  ...
  getAllData() {
    ...
    this.itemsDataFrom = this.interdataService.getStockdatas()[0].orders;
  }
  ...
  resetSomeProps() {
    ...
    this.interdataService.interdataList[0].id = '';
    this.interdataService.interdataList[0].gridData = [];
    this.interdataService.interdataList[0].status = '';
    this.interdataService.interdataList[0].totalQuantity = 0;
    this.interdataService.interdataList[0].transferQuantity = 0;
    this.interdataService.interdataList[0].totalItem = 0;
  }
      ...
      ItemDetails: [
        {
          ...
          ItemDescription: 'Ultimate Glow Cushion Foundation',
          ItemNumber: '1099688',
          BrandCategory: [
            {
              id: '7164@10002',
        ...
        },
        {
          ...
          ItemDescription: 'Ultimate Glow Fluid Foundation',
          ItemNumber: '1000868',
          BrandCategory: [
            {
              id: '6549@10002',
        ...
        },
        {
          ...
          ItemDescription: 'Her Eau de Toilette for Women',
          ItemNumber: '1000884',
          BrandCategory: [
            {
              id: '6549@10002',
        ...
        },
        {
          ...
          ItemDescription: 'Re-Nutriv Ultra Radiance Powder Makeup SPF16/PA+++',
          ItemNumber: '1052653',
          BrandCategory: [
            {
              id: '7159@10002',
  ...
  createNewOrder() {
    this.interdataService.interdataList[0].id = this.chooseNewProduct.id;
    this.interdataService.interdataList[0].toLocation =
    ...
    this.interdataService.interdataList[0].status = 'request';
    ...
    let order: any = {
      id: this.interdataService.interdataList[0].id,
      toLocation: this.interdataService.interdataList[0].toLocation,
      fromLocation: this.interdataService.interdataList[0].fromLocation,
      toDivision: this.interdataService.interdataList[0].toDivision,
      shipmentDeliveryDate:
        this.interdataService.interdataList[0].shipmentDeliveryDate,
      transferInitiatedDate:
        this.interdataService.interdataList[0].transferInitiatedDate,
      reference: this.interdataService.interdataList[0].reference,
      gridData: this.interdataService.interdataList[0].gridData,
      status: 'request',
      totalQuantity: this.interdataService.interdataList[0].totalQuantity,
      rlQuantity: this.interdataService.interdataList[0].transferQuantity,
      transferQuantity: this.interdataService.interdataList[0].transferQuantity,
      receiveQuantity: '0',
      specialProducts: 'No',
      weight: '',
      package_info: '',
      dimensions: '',
      totalItem: this.interdataService.interdataList[0].totalItem,
      isConsolidate: false,
    };

    this.interdataService.interdataList[0].orders.push(order);
  }
  ...
  onInitiate() {
    ...
    console.log(this.chooseNewProduct, this.interdataService.interdataList);
  }

  openDialogInit() {
    this.chooseNewProduct.id = Math.floor(Math.random() * 50000 + 1).toString();
    this.transferIdData = this.chooseNewProduct;
    this.transferIdData.header =
      'Order Request has been Initiatied Successfully';
    this.transferIdData.actionLbl = 'Send for Approval';
    ...
    dialogRef.afterClosed().subscribe((result) => {
      ...
      console.log(this.interdataService.interdataList);
    });
  }

  openApprovalDialogInit() {
    this.transferIdData = {};
    this.transferIdData.header = 'Order Request has been Approved';
    this.transferIdData.actionLbl = 'Send for Fulfillment';
    this.transferIdData.idType = 'ORDER ID';
    this.transferIdData.id = this.interdataService.interdataList[0].id;
